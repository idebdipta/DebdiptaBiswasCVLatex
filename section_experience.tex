...
\begin{experiences}
   \experience
    ...
    {
\begin{description}
        Equity analysis (Fundamental \& Technical), valuation: DCF, \& PE; \& qualitative analysis $\bullet$ Developed Zerodha like UI in spreadsheet to track holdings from different Brokers in a single consolidated portfolio $\bullet$ Developed alerting system to get automated emails whenever stock's target/SL is hit. \hfill \website{https://docs.google.com/spreadsheets/d/1FH0PlMJ_NGk5Sr5yjCsq5nPRQeU5jIz61zps0VsIuBg/edit?usp=sharing} {\footnotesize{Explore portfolio}}
    \end{description}
    }
